...
#ifndef PAYWINGSONBOARDINGKYC_SWIFT_H
#define PAYWINGSONBOARDINGKYC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PayWingsOnboardingKYC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21PayWingsOnboardingKYC31CountryCodePickerViewController") SWIFT_AVAILABILITY(ios,introduced=11.0)
...
@interface CountryCodePickerViewController (SWIFT_EXTENSION(PayWingsOnboardingKYC))
@end

@class UISearchController;

SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface CountryCodePickerViewController (SWIFT_EXTENSION(PayWingsOnboardingKYC)) <UISearchResultsUpdating>
- (void)updateSearchResultsForSearchController:(UISearchController * _Nonnull)searchController;
@end


SWIFT_CLASS("_TtC21PayWingsOnboardingKYC7NibView")
...
SWIFT_CLASS("_TtC21PayWingsOnboardingKYC17CountryPickerView")
...
SWIFT_CLASS("_TtC21PayWingsOnboardingKYC27CountryPickerViewController")
...
@interface CountryPickerViewController (SWIFT_EXTENSION(PayWingsOnboardingKYC)) <UISearchResultsUpdating>
- (void)updateSearchResultsForSearchController:(UISearchController * _Nonnull)searchController;
@end


@interface CountryPickerViewController (SWIFT_EXTENSION(PayWingsOnboardingKYC))
- (void)tableView:(UITableView * _Nonnull)tableView willDisplayHeaderView:(UIView * _Nonnull)view forSection:(NSInteger)section;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface CountryPickerViewController (SWIFT_EXTENSION(PayWingsOnboardingKYC)) <UISearchControllerDelegate>
...
@interface CountryPickerViewController (SWIFT_EXTENSION(PayWingsOnboardingKYC)) <UISearchBarDelegate>
...
SWIFT_CLASS("_TtC21PayWingsOnboardingKYC20PhoneNumberFormatter")
...
@interface PhoneNumberFormatter (SWIFT_EXTENSION(PayWingsOnboardingKYC))
...
SWIFT_CLASS("_TtC21PayWingsOnboardingKYC14PhoneNumberKit")
...
SWIFT_CLASS("_TtC21PayWingsOnboardingKYC20PhoneNumberTextField")
...
SWIFT_CLASS("_TtC21PayWingsOnboardingKYC15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOnboardingKYC)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOnboardingKYC)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOnboardingKYC)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PayWingsOnboardingKYC)) <NSURLSessionTaskDelegate>
...
@interface UINavigationController (SWIFT_EXTENSION(PayWingsOnboardingKYC))
